    ...
    <div class="l-wrapper" id="app">
        ...
        <main class="l-main">
            <div class="l-main__inner">
                <div class="p-terms">
                    <h1 class="c-page-heading">プライバシーポリシー</h1>
                    <p>nt1121（以下、「当方」といいます。）は、本ウェブサイト上で提供するサービス（以下,「本サービス」といいます。）における、ユーザーの個人情報の取扱いについて、以下のとおりプライバシーポリシー（以下、「本ポリシー」といいます。）を定めます。
                    </p>
                    <h2 class="p-terms__article-heading">第1条（個人情報）</h2>
                    ...
                    <h2 class="p-terms__article-heading">第2条（個人情報の収集方法）</h2>
                    <p>当方は、ユーザーが利用登録をする際にメールアドレスなどの個人情報をお尋ねすることがあります。</p>
                    <h2 class="p-terms__article-heading">第3条（個人情報を収集・利用する目的）</h2>
                    ...
                    <h2 class="p-terms__article-heading">第4条（利用目的の変更）</h2>
                    <ol>
                    ...
                    <h2 class="p-terms__article-heading">第5条（個人情報の第三者提供）</h2>
                    <ol>
                    ...
                    <h2 class="p-terms__article-heading">第6条（個人情報の開示）</h2>
                    <ol>
                    ...
                    <h2 class="p-terms__article-heading">第7条（個人情報の訂正および削除）</h2>
                    <ol>
                        <li>ユーザーは、当方の保有する自己の個人情報が誤った情報である場合には、当方が定める手続きにより、当方に対して個人情報の訂正、追加または削除（以下、「訂正等」といいます。）を請求することができます。
                        </li>
                    ...
                    <h2 class="p-terms__article-heading">第8条（個人情報の利用停止等）</h2>
                    <ol>
                        <li>当方は、本人から、個人情報が、利用目的の範囲を超えて取り扱われているという理由、または不正の手段により取得されたものであるという理由により、その利用の停止または消去（以下、「利用停止等」といいます。）を求められた場合には、遅滞なく必要な調査を行います。
                        </li>
                    ...
                    <h2 class="p-terms__article-heading">第9条（プライバシーポリシーの変更）</h2>
                    <ol>
                        <li>本ポリシーの内容は、法令その他本ポリシーに別段の定めのある事項を除いて、ユーザーに通知することなく、変更することができるものとします。</li>
                        <li>当方が別途定める場合を除いて、変更後のプライバシーポリシーは、本ウェブサイトに掲載したときから効力を生じるものとします。</li>
                    </ol>
                    <h2 class="p-terms__article-heading">第10条（お問い合わせ窓口）</h2>
                    <p>本ポリシーに関するお問い合わせは、下記の窓口までお願いいたします。</p>
                    <p>Eメールアドレス：{{ config('mail.from.address') }}</p>
